...
import { Trash2, Users, ChevronRight, X, Plus, Minus, Mic, Square, Play as PlayIcon, MapPin } from 'lucide-react';
        ...
        {keyframes.map((kf, idx) => {
          ...
          return (
            ...
            >
              ...
              <span className="text-foreground">{formatTime(kf.time)}</span>
